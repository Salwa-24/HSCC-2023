...
def distribution_fitting(datafilepath,colname,title): 
    ...
    print(stats.kstest(df[colname], "norm", parameters))
...
def main():
  ...
  #Method instances are created and arguments are passed respectively  
   ...
   #Method instances are created and arguments are passed respectively  
   mdistribution_fitting=distribution_fitting("datasets/HSCC-2023-kstest.csv",'idle_delta','idle_delta original')
   mdistribution_fitting=distribution_fitting("datasets/HSCC-2023-kstest.csv", 'internal_delta','internal_delta original')
   mdistribution_fitting=distribution_fitting("datasets/HSCC-2023-kstest.csv", 'internalhard_delta','internalhard_delta original')
